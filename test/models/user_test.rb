...
class UserTest < ActiveSupport::TestCase
  ...
  invalid_addresses = %w[user@example,com user_at_foo.org user.name@example.foo@bar_baz.com
    ...
    @user.password = 'a' * 5 #можно использовать параллельное присваивание одного значения двум атрибутам
      @user.password_confirmation = 'a' * 5 #можно использовать параллельное присваивание одного значения двум атрибутам
      assert_not @user.valid?
    end
end